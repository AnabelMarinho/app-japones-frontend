...
import { PalavraDiaCardComponent } from '../../components/palavra-dia-card/palavra-dia-card.component';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [SHARED_IMPORTS, BarraProgresso, FlashcardMiniComponent, ContinueLessonCardComponent, PalavraDiaCardComponent],
